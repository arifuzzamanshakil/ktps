    ...
    data.map((getData, index) => (
     ...
     <div id='nalox' className='flex-col flex gap-16'>
      ...
      <div className="flex gap-8">
       <div className=" absolute mt-[100px] ml-7"><img src={dash} alt="" /></div>
       <div>
       ...
       <div className="w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-10">
        <h2 className="text-[32px] font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white ">{getData.unpack.title.en}</h2>
        <p className='text-lg  text-white font-Inter font-medium drop-shadow-9xl pt-5 '>{getData.unpack.des.en}</p>
        <p className='text-lg  text-white font-Inter font-medium drop-shadow-9xl pt-4 '>{getData.unpack.des2.en} <a href="#" className="text-[#97E4FC] underline">{getData.unpack.des3.en}</a>{getData.unpack.des4.en}</p>
       </div>

      </div>

      <div id='nonuser' className="flex gap-8">
