   ...
   <div id='nalox' className='flex-col flex xl:gap-16 lg:gap-14 gap-3'>
    <div className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline">
     ...
     <div className="lg:w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
      <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white ">{data.unpack.title.en}</h2>
      <p className='lg:text-lg text-base text-white font-Inter md:font-medium font-normal drop-shadow-9xl pt-5 '>{data.unpack.des.en}</p>
      <p className='lg:text-lg text-base text-white font-Inter font-normal md:font-medium drop-shadow-9xl pt-4 '>{data.unpack.des2.en} <a href="#" className="text-[#97E4FC] underline">{data.unpack.des3.en}</a>{data.unpack.des4.en}</p>
     </div>
    ...
    <div id='nonuser' className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline">
     ...
     <div className="lg:w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
      <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white">{data.unpack.title2.en}</h2>
      <p className='text-lg  text-white font-Inter font-normal md:font-medium drop-shadow-9xl pt-5 '>{data.unpack.des5.en}</p>
     </div>
    </div>
    ...
    <section id='testStrips' className='h-full' >
     <div className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline" >
      ...
      <div className="lg:w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
       <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white ">{data.unpack.title3.en}</h2>
       <p className='text-lg  text-white font-Inter font-normal md:font-medium drop-shadow-9xl pt-5 '>{data.unpack.des6.en} <a href="#" className="text-[#97E4FC] underline">{data.unpack.des7.en}</a> {data.unpack.des8.en}<a href="#" className="text-[#97E4FC] underline">{data.unpack.des9.en}  </a> {data.unpack.des10.en} <a href="#" className="text-[#97E4FC] underline">{data.unpack.des11.en} </a>  {data.unpack.des12.en}  <a href="#" className="text-[#97E4FC] underline">{data.unpack.des13.en} </a> </p>
    ...
    <div className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline">
     ...
     <div className="border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
      <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white">{data.unpack.title4.en}</h2>
      <div id="overdose">
       <AccordionBox />
      </div>
    ...
    <div className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline">
     ...
     <div className="lg:w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
      <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white">{data.unpack.title5.en}</h2>
    ...
    <div className="flex gap-8 flex-col items-center lg:flex-row lg:items-baseline">
     ...
     <div className="lg:w-[1060px] border border-[#E5AEEE] bg-[#B158BF1A] rounded-[14px] p-5 lg:p-10 text-center lg:text-left">
      <h2 className="lg:text-[32px] text-2xl font-Rajdhani font-semibold tracking-[3.2px] drop-shadow-5xl text-white">{data.unpack.title6.en}</h2>
      <p className='text-lg  text-white font-Inter font-normal drop-shadow-9xl pt-5 '>{data.unpack.des6.en} <a href="#" className="text-[#97E4FC] underline">{data.unpack.des7.en}</a> {data.unpack.des14.en}</p>
