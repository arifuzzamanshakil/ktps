    ...
    <div className="h-full bg-cover bg-no-repeat bg-center pt-14 md:pt-24 w-[335px] sm:w-[500px] md:w-full mx-auto">
      {
        data.map((getData, index) => (
          ...
          <div>
            ...
            <div className='justify-between flex flex-wrap gap-5 mx-auto items-start py-0 md:py-10 lg:w-[1010px] xl:w-[1150px] md:w-[770px] '>
              ...
              <div className="card lg:w-[465px] md:w-[370px] gap-5 flex flex-col">
                <div className="card_head flex flex-col md:flex-row items-center gap-0">
                  ...
                  <h3 className=' font-Rajdhani md:text-2xl text-xl font-normal text-[#FFC1E5] drop-shadow-6xl text-left ' key={data.getData}>{getData.DetailsSec.header4.en.title}</h3>
                </div>
